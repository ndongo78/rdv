...
const OrdersSender = (props: Props) => {
  return (
  ...
  />
              ...
              <View>
              <Text className="text-white font-medium">Envoyé le 15/02/2025</Text>
              <TouchableOpacity>
               <Text className="text-right text-amber-300 underline font-bold text-lg">Suivre</Text>
              </TouchableOpacity>
              </View>
            </View>
